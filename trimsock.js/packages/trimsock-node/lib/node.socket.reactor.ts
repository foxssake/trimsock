...
export class NodeSocketReactor extends Reactor<net.Socket> {
  public serve(options?: net.ServerOpts, connectionListener?: (socket: net.Socket) => void): net.Server {
  ...
  public connect(options: net.NetConnectOpts, connectionListener?: () => void): net.Socket {
  ...
  protected write(data: string, target: net.Socket): void {
    ...
    target.write(data, (err?) => { err && console.error(err) })
  }
}
